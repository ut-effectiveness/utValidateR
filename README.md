...
student_check_result <- do_checks(student_df, student_checks) %>% 
  glimpse()
#> New names:
#> • `S30a_status` -> `S30a_status...24`
#> • `S17b_status` -> `S17b_status...25`
#> • `S17b_status` -> `S17b_status...26`
#> • `S18b_status` -> `S18b_status...28`
#> • `S18b_status` -> `S18b_status...29`
#> • `S30a_status` -> `S30a_status...41`
...
#> New names:
#> New names:
#> • `S17b_activity_date...21` -> `S17b_activity_date...76`
#> • `S17b_error_age...22` -> `S17b_error_age...77`
#> • `S17b_activity_date...23` -> `S17b_activity_date...78`
#> • `S17b_error_age...24` -> `S17b_error_age...79`
#> Rows: 10,000
#> Columns: 155
...
#> $ S00a_error_age                          <dbl> 705, 483, 422, 1470, 574, 320,…
...
#> $ S10a_error_age                          <dbl> 1393, 1388, 835, 492, 790, 143…
#> $ S10a_status                             <chr> "Pass", "Pass", "Pass", "Pass"…
#> $ S11a_activity_date                      <date> 2018-09-27, 2018-10-02, 2020-…
#> $ S11a_error_age                          <dbl> 1393, 1388, 835, 492, 790, 143…
...
#> $ S17b_activity_date...97                 <date> 2020-12-24, 2021-06-28, 2020-…
#> $ S17b_activity_date...98                 <date> 2020-12-24, 2021-06-28, 2020-…
#> $ S17b_error_age...99                     <dbl> 574, 388, 664, 1296, 430, 1066…
#> $ S17b_error_age...100                    <dbl> 574, 388, 664, 1296, 430, 1066…
#> $ S17b_status...101                       <chr> "Pass", "Pass", "Pass", "Pass"…
#> $ S17b_status...102                       <chr> "Pass", "Pass", "Pass", "Pass"…
#> $ S18a_status                             <chr> "Pass", "Pass", "Pass", "Failu…
#> $ S18b_status...104                       <chr> "Pass", "Pass", "Pass", "Pass"…
#> $ S18b_status...105                       <chr> "Pass", "Pass", "Pass", "Pass"…
#> $ S19a_activity_date                      <date> 2020-12-24, 2021-06-28, 2020-…
#> $ S19a_error_age                          <dbl> 574, 388, 664, 1296, 430, 1066…
