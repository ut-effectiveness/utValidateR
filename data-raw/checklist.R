...
rule_spec <- tribble(
  ...
  "C19a", expr(is_missing_building_number(building_number_1, meet_start_time_1, meet_days_1)),
  "C27a", expr(is_missing_building_number(building_number_2, meet_start_time_2, meet_days_2)),
  "C35a", expr(is_missing_building_number(building_number_3, meet_start_time_3, meet_days_3)),
