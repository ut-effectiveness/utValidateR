...
rule_spec <- tribble(
  ...
  "C18a", expr(course_conditional_check(meet_building_id_1, instruction_method_code, section_format_type_code, budget_code, campus_id)),
  "C26a", expr(course_conditional_check(meet_building_id_2, instruction_method_code, section_format_type_code, budget_code, campus_id)),
  "C34a", expr(course_conditional_check(meet_building_id_3, instruction_method_code, section_format_type_code, budget_code, campus_id)),
  "C19a", expr(course_conditional_check(building_number_1, instruction_method_code, section_format_type_code, budget_code, campus_id)),
  "C27a", expr(course_conditional_check(building_number_2, instruction_method_code, section_format_type_code, budget_code, campus_id)),
  "C35a", expr(course_conditional_check(building_number_3, instruction_method_code, section_format_type_code, budget_code, campus_id)),
